...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    public HelloClass sayHelloByName (@Named("name") String name, @Named("period") String period) {
        return new HelloClass(name, null);
    }
    ...
    @ApiMethod(name ="writeGender", path = "writeGender", httpMethod = HttpMethod.GET)
    public GenderClass writeGender(@Named("gender") String gender){
    return new GenderClass(gender);
    }
